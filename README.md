...
## String
  ...
  - [알](/fundamentals/string/manacher/) | [manacher's algorithm](/doc/string_manacher.md)

## Tree
  - F | [overview](doc/tree.md)
  - F | [terms and definitions](doc/tree_terms_and_definitions.md)
  - F | [binary search tree](fundamentals/tree/binarysearchtree/README.md)
  - F | red black tree (balanced binary search tree)
  - F | AVL tree (balanced binary search tree)
  - F | [treap](fundamentals/tree/treap/README.md)
  ...
  - [알](fundamentals/tree/heap/) | [heap for priority queue](doc/tree_heap.md)
...
## Graph
  ...
  - 백 | [순열 사이클](https://www.acmicpc.net/problem/10451)
  - 백 | [반복수열](https://www.acmicpc.net/problem/2331)
  - 백 | [텀 프로젝트](https://www.acmicpc.net/problem/9466)
...
## Sort
  ...
  - 백 | [나이순 정렬](https://www.acmicpc.net/problem/10814)
  - 백 | [국영수](https://www.acmicpc.net/problem/10825)
  - 백 | [수 정렬하기 3](https://www.acmicpc.net/problem/10989)
  - 백 | [카드](https://www.acmicpc.net/problem/11652)
...
## Search
  - [upper_bound, lower_bound](fundamentals/search/upperlowerbound/README.md)
...
## Dynamic Programming
  ...
  - 백 | [1, 2, 3 더하기](https://www.acmicpc.net/problem/9095)
  - 백 | [붕어빵 판매하기](https://www.acmicpc.net/problem/11052)
  ...
  - 백 | [계단 오르기](https://www.acmicpc.net/problem/2579)
  - 백 | [제곱수의 합](https://www.acmicpc.net/problem/1699)
  - 백 | [타일 채우기](https://www.acmicpc.net/problem/2133)
  - 백 | [파도반 수열](https://www.acmicpc.net/problem/9461)
  - 백 | [합분해](https://www.acmicpc.net/problem/2225)
  - 백 | [암호코드](https://www.acmicpc.net/problem/2011)
...
## Combinatorial Search
  ...
  - [알](/algospot/TSP2/) | [TSP](https://algospot.com/judge/problem/read/TSP2)
    - dynamic programming
    - backtracking
    - simple pruning
  ...
  - [알](/algospot/BOARDCOVER2) | [BOARDCOVER2](https://algospot.com/judge/problem/read/BOARDCOVER2)
  - [알](/algospot/ALLERGY) | [ALLERGY](https://algospot.com/judge/problem/read/ALLERGY)
  - [알](/algospot/KAKURO2) | [KAKURO2](https://algospot.com/judge/problem/read/KAKURO2)
  ...
  - [알](/algospot/NQUEEN/) | [NQUEEN](https://algospot.com/judge/problem/read/NQUEEN)
